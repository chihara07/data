...
public:
	...
	*/
	...
	/**
		@brief	
		\~English	Get a depth texture and parameters to reconstruct from _Z to depth
	...
	*/
	...
	/**
		@brief	
		\~English	Specify a depth texture and parameters to reconstruct from _Z to depth
...
::Effekseer::MaterialLoaderRef CreateMaterialLoader(::Effekseer::Backend::GraphicsDeviceRef graphicsDevice, ::Effekseer::FileInterfaceRef fileInterface = nullptr);
